...
Python工程的结构
<img src="模块.assets/image-20220323184600277.png" alt="image-20220323184600277" style="zoom:50%;" />
...
<img src="模块.assets/image-20220315161538665.png" alt="image-20220315161538665" style="zoom:50%;" />
...
<img src="模块.assets/image-20220315165803518.png" alt="image-20220315165803518" style="zoom: 50%;" />
...
<img src="模块.assets/image-20220323183823777.png" alt="image-20220323183823777" style="zoom:67%;" />

​	其中__init__.py的作用有两个，第一个是标识当前目录是一个Python包；第二便是模糊导入。如果__init__.py文件中没有生命__all__属性，那么使用"from...import..."导入的内容为空。
...
在当前工程下新增package，取名Package01，并在保中创建模块mudule_a.py，并定义函数：
...
<img src="模块.assets/image-20220323191522324.png" alt="image-20220323191522324" style="zoom:50%;" />
